...
let verifiedPlayer2: UserProfile | null = null;
...
function clearPlayer2Verification(): void {
	verifiedPlayer2 = null;
...
async function startPongPvP(): Promise<void> {
...
async function startPongAI(difficulty: number): Promise<void> {
...
function showGuestVsGuestSetup(): void {
	showModal(`
...
function showPlayer2Setup(currentUser: UserProfile): void {
...
function showPlayer2VerifyModal(): void {
	showModal(`
    <div class="card text-center space-y-4 max-w-md mx-auto">
...
async function loginPlayer2Direct(): Promise<void> {
...
async function backToPlayer2Setup(): Promise<void> {
	const currentUser = await getCurrentUser();
	if (currentUser) {
		showPlayer2Setup(currentUser);
	}
...
async function confirmGuestVsGuest(): Promise<void> {
...
async function confirmPlayer2Setup(): Promise<void> {
	const currentUser = await getCurrentUser();
...
function startPongWithPlayers(player1: Player, player2: Player): void {
	// Start session
	startGameSession({
		player1,
		player2,
...
function setupPongGameEndHandler(): void {
...
async function startTicTacToePvP(): Promise<void> {
	hideModal();
	await setupTicTacToe(false);
}

function showTicTacToeDifficulty(): void {
	showModal(`
		<div class="card text-center space-y-4">
...
async function startTicTacToeAI(difficulty: number): Promise<void> {
	hideModal();
