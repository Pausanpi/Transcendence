...
function showToast(message: string, type: 'success' | 'error'): void {
	...
	if (window.languageManager?.t) {
		if (message === 'Friend request sent!') translated = window.languageManager.t('players.friendRequestSent') || message;
		if (message === 'Failed to send request') translated = window.languageManager.t('players.failedToSendRequest') || message;
		if (message === 'Failed to send friend request') translated = window.languageManager.t('players.failedToSendFriendRequest') || message;
	}
