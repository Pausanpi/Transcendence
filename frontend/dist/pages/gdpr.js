import { loadUserData, anonymizeUserData, deleteAccount, loadUserConsent, updateConsent } from '../gdpr.js';
export function renderGdpr() {
...
async function initGdpr() {
    try {
        ...
        if (consent) {
            document.getElementById('dataProcessing').checked = consent.dataProcessing;
            document.getElementById('marketingEmails').checked = consent.marketingEmails;
...
function displayUserData(data) {
    ...
    if (!summaryDiv || !data?.dataSummary)
        return;
...
window.showAnonymizeModal = showAnonymizeModal;
window.hideAnonymizeModal = hideAnonymizeModal;
window.showDeleteModal = showDeleteModal;
window.hideDeleteModal = hideDeleteModal;
window.confirmAnonymize = confirmAnonymize;
